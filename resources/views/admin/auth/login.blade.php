...
<head><base href="../../../">
    ...
    <link href="{{asset('admin/css/pages/login/login-1.css?v=7.0.5')}}" rel="stylesheet" type="text/css" />
...
<script src="{{asset('admin/js/pages/custom/login/login-general.js?v=7.0.5')}}"></script>
<!--end::Page Scripts-->
</body>
<!--end::Body-->
</html>
