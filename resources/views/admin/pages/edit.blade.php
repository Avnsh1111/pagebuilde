    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            <div class="card card-custom">
                ...
                @endif
                <form enctype="multipart/form-data" action="{{route('admin.pages.update',$page->id)}}" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="image-input image-input-empty image-input-outline" id="kt_image_5" style="background-image: url({{url('uploads/'.$page->featured_image)}})">
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" name="color" class="form-control" id="color" placeholder="select background color" value="{{$page->background_color}}"/>
                        </div>

                        <div class="checkbox-inline">
                            <label class="checkbox checkbox-lg">
                                <input type="checkbox" checked="checked" name="is_home_page" @if($page->is_main_page == 1) checked @endif/>
                                <span></span>
                                Is Home Page
                            </label>
                        </div>
